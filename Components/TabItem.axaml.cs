...
namespace ModAPI.Components
{
    public partial class TabItem : UserControl
    {
        ...
        public static readonly StyledProperty<IImage> ImageIconProperty = AvaloniaProperty.Register<TabItem, IImage>(nameof(ImageIcon));
        ...
        public static readonly StyledProperty<Material.Icons.MaterialIconKind?> MaterialIconProperty = AvaloniaProperty.Register<TabItem, Material.Icons.MaterialIconKind?>(nameof(MaterialIcon));
        public string DisplayName { get { return GetValue(DisplayNameProperty); } set { SetValue(DisplayNameProperty, value); } }
        public static readonly StyledProperty<string> DisplayNameProperty = AvaloniaProperty.Register<TabItem, string>(nameof(DisplayName));
        public bool IsHeader { get { return GetValue(IsHeaderProperty); } set { SetValue(IsHeaderProperty, value); } }
        public static readonly StyledProperty<bool> IsHeaderProperty = AvaloniaProperty.Register<TabItem, bool>(nameof(IsHeader));
        public bool IsActive { get { return GetValue(IsActiveProperty); } set { SetValue(IsActiveProperty, value); } }
        public static readonly StyledProperty<bool> IsActiveProperty = AvaloniaProperty.Register<TabItem, bool>(nameof(IsActive));
